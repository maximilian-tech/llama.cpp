...
./_build/bin/llama-perplexity -ngl 300 --ctx-size 4096 -s 1 -t ${NCPUS} --perplexity -m ${PREFIX}-F16.gguf --file ./Meta-Llama-3-8B/wiki.train.raw --chunks 10 2>&1 | tee ppl.F16
...
for rate in 3.0 3.5 4.0 4.5 5.0 6.0 8.0 ; do
    ...
    ./_build/bin/llama-perplexity -ngl 300 --ctx-size 4096 -s 1 -t ${NCPUS} --perplexity -m ${PREFIX}-F16_${OUTPUT_NAME}.gguf --file ./Meta-Llama-3-8B/wiki.train.raw | tee ppl.${OUTPUT_NAME}
